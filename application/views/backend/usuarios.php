                                ...
                                <div class="col-lg-12">
                                    ...
                                    <?php 
                                        ...
                                        foreach ($usuarios as $usuario) {
                                            ...
                                            if($usuario->foto == 1) { 
                                                $fotouser= img("assets/frontend/img/usuarios/".$usuario->id.".jpg"); 
                                            } else {
                                                $fotouser= img("assets/frontend/img/semFoto.png"); 
                                            }
                                            $emailuser = $usuario->email;
                                            $alterar= anchor(base_url('admin/usuarios/alterar/'.$usuario->id), '<i class="fa fa-refresh fa-fw"></i> Alterar'); // Anchor serve para usar o helper
                                            $excluir= anchor(base_url('admin/usuarios/excluir/'.$usuario->id), '<i class="fa fa-remove fa-fw"></i> Excluir'); // A vírgula serve de 'alias' 
